...
class Individual(object):
    ...
    def mutate(self):
        ...
        init_prompt = ("We are testing an UAV control system. Based on the current state of UAV， you will serve as a predictor to determine which test case "
                   ...
                   "#Current state of UAV\nThe drone will take off from coordinate (0,0), fly to coordinate (45,50), and then fly to coordinate (35,60), and then return to coordinate (-20,0).\n" 
        ...
        interesting_generation = GPT_object(init_prompt=init_prompt)
